...
## Описание проекта
Ассемблер, преобразующий программы из человекочитаемого CSV-формата в машинный код для УВМ. 
...
- Входной файл: программы для ассемблера должны быть в формате **CSV** и иметь расширение `.csv`.
...
read_csv - считывание файла csv\
parse_command - разбиение команды из полученного списка\
make_bytes - переформирование данных в байты\
write_file - записать в файл данные\
